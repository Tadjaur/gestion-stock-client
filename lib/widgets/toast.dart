...
class Toast extends StatefulWidget {
  ...
  const Toast({
    ...
    this.waitDuration,
    this.showDuration,
    this.toastStreamHandler,
    @required this.child,
    this.longPressHandler,
  })  : assert(child != null),
        assert((showAsTooltip == true && toastStreamHandler != null) || (showAsTooltip != true && message != null),
            "ERROR_MESSAGE:: if showAsTooltip is true, toastHandler must not be null"),
        super(key: key);
  ...
  final double height;
  final bool showAsTooltip;
  final Stream<String> toastStreamHandler;
  final bool Function() longPressHandler;
  ...
  /// [Toast.message]. Set this property to true if the app is going to
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<bool>('show as tooltip', showAsTooltip, defaultValue: false));
  }
}
...
class _ToastState extends State<Toast> with SingleTickerProviderStateMixin {
  ...
  static const bool _defaultshowAsTooltip = false;
  double height;
...
// We create this widget outside of the overlay entry's builder to prevent
  ...
  void _listenForShow(String msg) {
    if (msg != null && msg.length > 0) {
      message = msg;
    }
    if (message != null) {
      _showTooltip();
      Timer(showDuration + waitDuration, _hideTooltip);
    } else {
      _hideTooltip();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    showAsTooltip = widget.showAsTooltip ?? _defaultshowAsTooltip;
    message = widget.message;
    if (showAsTooltip) {
      widget.toastStreamHandler.listen(_listenForShow);
      return widget.child;
    }
